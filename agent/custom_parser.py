"""
Custom output parser for MRKL agent that properly handles JSON tool inputs.
"""
import json
import re
...
class JSONCapableMRKLOutputParser(MRKLOutputParser):
    """
    Custom MRKL output parser that properly parses JSON in Action Input.
...
# Keep the old ReAct parser for backward compatibility
